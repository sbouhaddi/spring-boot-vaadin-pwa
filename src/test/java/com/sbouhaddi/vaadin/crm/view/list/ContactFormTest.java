package com.sbouhaddi.vaadin.crm.view.list;
...
import com.sbouhaddi.vaadin.crm.ui.view.list.ContactForm;
...
public class ContactFormTest {
	...
	public void setupData() {
		...
		marcUsher.setStatus(Status.NotContacted);
	...
	public void formFieldsPopulated() {
		...
		Assert.assertEquals(Status.NotContacted, form.status.getValue());
	}
	...
	public void saveEventHasCorrectValues() {
		...
		form.status.setValue(Status.Customer);
		...
		Assert.assertEquals(Status.Customer, savedContact.getStatus());
	}
}
